function plotFilteredNormData(data, minval, maxval)
%plotFilteredNormData (data, min, max)
% Inputs:
% data - the 2 column array data storing the measurement and the age 
% minval - the minimum age of measurements to be taken into account
% maxval - the maximum age of measurements to be taken into account
%
...
for i=1:size(data,1)
	...
	if data(i,2) > minval && data(i,2) < maxval
